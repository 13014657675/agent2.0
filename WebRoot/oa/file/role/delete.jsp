...
<head>
	...
	<body>
		<table width="100%" border="1" cellspacing="0">
			...
			<tr>
			<td width="33%"><div align="center">工号</div></td> 
			<td width="33%"><div align="center">姓名</div></td>
			<td width="33%"><div align="center">删除</div></td>
			</tr>
			<sql:query var="q1" dataSource="${db_mssql }" sql=" select a.*,b.c_name from t_role a,t_staff b where a.c_sys=1 and a.c_role=101 
