...
<head>
	...
	<c:when test="${param.c_libraryid eq 1}">
		...
		<nested:hidden property="c_jobnm" value="ck"></nested:hidden> 	
		...
		<nested:hidden property="c_libraryid" value="${param.c_libraryid }"></nested:hidden>	
		  <table width="100%" border="1" cellspacing="0" id="tb1">
			...
			<tr>
				<td width="25%" align="center">出库单号</td> 
			...
			<tr>
				...
				<td width="25%" align="center"><b>选择出库编号</b></td> 
			</tr> 				 
			...
			<tr>
				...
				<option value="2">领用机构</option>
				</select>				
				</td>
				<td width="25%" align="center" id="ck"></td>
		...
		<script type="text/javascript">				 
			...
			{ 				 
				...
				var cell=document.getElementById("ck")
				if (type == 1)
				{
					cell.innerHTML="<td width=\"20%\" align=\"center\"><input type=\"text\" name=\"goodsrecord.c_p\" value=\"\" id=\"req\" title=\"入库人必须填写\"></td>";	
				}
				if (type == 2)
				{
					var x="<select name=\"c_orgtypeid\" id=\"c_orgtypeid\" onchange=\"setorg()\">";
					<c:forEach items="${a1.rows }" var="row">
					x+="<option value=\"${row.c_no }\">${row.c_name } </option>"
					</c:forEach>
					x+="</select><select name=\"goodsrecord.c_o\" id=\"c_orgid\" ></select>"
					cell.innerHTML="<td width=\"20%\" align=\"center\">"+x+"</td>";
					setorg()
				} 
			}
			function setorg()
			{  
				...
				Organization.get_typeorg(c_orgtypeid, getorg);
				return false;
			}
		...
		<nested:hidden property="c_libraryid" value="${param.c_libraryid }"></nested:hidden>	
		  <table width="100%" border="1" cellspacing="0" id="tb1">
			...
			<tr>
				...
				<td width="20%" align="center"><b>输入出库数量</b></td>
				<td width="20%" align="center">					 				
				</td>
			</tr> 				 
			<tr>
			...
			<tr>
				...
				<td width="20%" align="center" id="ck"></td>
				<td width="20%" align="center"> </td> 
				<td width="20%" align="center"> </td> 
