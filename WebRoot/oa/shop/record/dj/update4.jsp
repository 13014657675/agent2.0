		...
		<nested:hidden property="c_libraryid" value="${param.c_libraryid }"></nested:hidden>
		  <table width="100%" border="1" cellspacing="0" id="tb1">
			...
			<sql:query var="q2" dataSource="${db_mssql }" sql="select * from t_goodsbatch  
					where c_orgid=${param.c_orgid } and c_libraryid=${param.c_libraryid } and c_recordid=${param.c_recordid } and c_flag='0' and c_jobnm='dj'"></sql:query>
			...
			<tr>
				...
				<td width="20%" align="center">
				<nested:text property="c_inprice"   value="${row.c_inprice }" onchange="reg_num(this)"></nested:text>
				</td>
				<td width="20%" align="center">
				<nested:text property="c_outprice"  value="${row.c_outprice }" onchange="reg_num(this)"></nested:text>
				</td>
			</tr> 		
			</c:forEach>
			<tr>
