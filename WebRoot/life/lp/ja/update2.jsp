...
<body>	 
	<sql:query var="q1" dataSource="${db_mssql }" sql="select * from t_sxlp 
		where c_orgid=${param.c_orgid } and c_companyid=${param.c_companyid } and c_jobnm='ja'"></sql:query>
	<table width="100%" border="1" cellspacing="0" id="table">
			...
			<td width="25%"> 
			<A href="../../../toModule.do?prefix=/life&page=/lp/ja/update3.jsp?c_no=${row.c_no }">结案修改</A>					
			</td>
			</tr>
			</c:forEach>			 
		</table> 
