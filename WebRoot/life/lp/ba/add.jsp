	...
	<nested:hidden property="c_no" value="1"/>
		<table width="100%" border="1" cellspacing="0" id="table">
			...
			<tr>
				...
				<td > 
					<nested:text property="c_bd" value="" styleId="req" title="保单号必须填写"  size="40"></nested:text>					 
				</td>
			</tr>
			<tr>
				<td   align="right">
				...
				<td  > 
					<nested:text property="c_tbrname" value="" styleId="req" title="投保人姓名必须填写"></nested:text> 
				</td>
			</tr>	
			<tr>
				<td   align="right">
				...
				<td > 
					<nested:text property="c_barq" value="" maxlength="8" styleId="req" title="报案时间必须填写"></nested:text> 
				</td>
			</tr>	
				<tr>
				<td   align="right" >
				...
				<td  > 
					<nested:textarea property="c_basm" value="" styleId="req" title="报案说明必须填写" cols="100" rows="5"></nested:textarea> 
				</td>
			</tr>				 			
			</nested:nest>			
			<tr>
