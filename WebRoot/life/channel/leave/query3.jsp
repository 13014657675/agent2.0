...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../../tool/styles/main.css">	
		...
		<table width="100%" border="1" cellspacing="0">
				...
				<sql:query var="q1" sql="select * from t_agentset where c_jobnumber='${param.c_jobnumber }' and c_system=2 and c_flag='1' " dataSource="${db_mssql }"></sql:query>
				</c:when> 
				...
				<sql:query var="q1" sql="select  * from t_agentset where c_orgid in (select c_no from t_organization where c_path like '${p2.rows[0].c_path }' and c_flag='0' )
				 	and c_system=2 and c_flag='1' order by c_jobnumber " dataSource="${db_mssql }"></sql:query> 
				</c:when>					 			
				</c:choose>					
