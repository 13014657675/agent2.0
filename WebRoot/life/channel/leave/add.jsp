...
<body  onload="set()">		  
		<form action="../../../toModule.do?prefix=/life&page=/channel/leave/add3.jsp?c_type=1" method="post" onsubmit="return check_form(this)">	 
		...
		<form action="../../../toModule.do?prefix=/life&page=/channel/leave/add2.jsp" method="post">
