	...
	<link rel="stylesheet" type="text/css" href="../../../tool/styles/main.css">	
		...
		<table width="100%" border="1" cellspacing="0">
			...
			<tr>
				...
				<td width="10%">性别</td>
				<td width="23%">									
					<c:set target="${channelForm.agent }" property="c_sex" value="${q1.rows[0].c_sex }"></c:set>
			...
			<tr>			
				...
				<td>婚姻状况</td>
				<td> 
					<c:set target="${channelForm.agent }" property="c_marriage" value="${q1.rows[0].c_marriage }"></c:set>
