...
<body  onload="set()">		  
		...
		<form action="../../../toModule.do?prefix=/life&page=/channel/entry/update-org4.jsp?c_jobnumber=${param.c_jobnumber }" method="post">
		<table width="100%" border="1" cellspacing="0">
			<tr>
				...
				<tr>
				<td align="right" width="50%">选择目标机构的机构类型</td>
				<td> 
