...
<body>
		...
		<table width="100%" border="1" cellspacing="0">
			...
			<tr>
				...
				<td width="10%">性别</td>
				<td width="23%">									
					<c:set target="${channelForm.agent }" property="c_sex" value="1"></c:set>
			...
			<tr>			
				...
				<td>婚姻状况</td>
				<td> 
					<c:set target="${channelForm.agent }" property="c_marriage" value="0"></c:set>
			...
			<tr>		
				...
				<td><input type="password" name="c_bankcode2" value="" size="30" id="req" title="重复银行卡号必需填写" accesskey="两次输入银行卡号不一致" onblur="reg_same(document.getElementsByName('agent.c_bankcode')[0],this)"></td>
			</tr>			
			<tr>
