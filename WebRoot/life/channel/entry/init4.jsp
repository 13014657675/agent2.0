...
<head>
	...
	<body>	
		...
		<c:if test="${q.rows[0].c_order==3 }"> 
			...
			<html:hidden property="jobname" value="agent_back"/>
			...
			<tr>
				...
				<td><nested:hidden property="c_jobnumber" value="${param.c_jobnumber }"></nested:hidden> 
					${param.c_jobnumber }</td>
			</tr>
			<tr>
			...
			<tr>
				<td width="48%"><div align="right">选择目标机构：${fn:trim(top3.rows[0].c_name) }</div></td>
				<td width="52%" >
				<div align="left"> 
					<nested:select property="o_orgid" styleId="c_orgid"></nested:select>
				</div>
				</td>
			</tr>				 	 	
			<tr>
		...
		<c:if test="${q.rows[0].c_order==4 }">
			...
			<tr>
				<td width="48%"><div align="right">选择目标机构：${fn:trim(top4.rows[0].c_name) }</div></td>
				<td width="52%" >
				<div align="left">
					<nested:select property="o_orgid" styleId="c_orgid"></nested:select> 
				</div>
		...
		<c:if test="${q.rows[0].c_order==5 }">
			...
			<tr>
				<td width="48%"><div align="right">选择目标机构：${fn:trim(top5.rows[0].c_name) }</div></td>
				<td width="52%" >
				<div align="left">
					<nested:select property="o_orgid" styleId="c_orgid"></nested:select>  
				</div>
