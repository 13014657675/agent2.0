	...
	<body>	
		...
		<c:if test="${q.rows[0].c_order==3 }">
			...
			<tr>
				...
				<td width="52%" >
				<div align="left"> 
					<nested:select property="c_orgid" styleId="c_orgid"></nested:select> 
				</div>
				</td>
			</tr>				 	 	
			<tr>
			...
			<td><nested:text property="c_code" value="" title="网点代码必需填写" styleId="req"></nested:text> </td>
			</tr>
			<tr>
			<td align="right">网点名称</td>
			<td><nested:text property="c_name" value="" size="30" title="网点名称必需填写" styleId="req"></nested:text> </td>
			</tr>
			<tr>
			<td align="right">电话</td>
			<td><nested:text property="c_phone" value="" ></nested:text> </td>
			</tr>
			<tr>
			<td align="right">地址</td>
			<td><nested:text property="c_address" value="" size="50"></nested:text> </td>
			</tr>			
			<tr>
		...
		<c:if test="${q.rows[0].c_order==4 }">
			...
			{  
				...
				Organization.get_childdept_typesystem(jigou3,3001,2, get3);
				return false;
			}
			function get3(datas)
			{	
