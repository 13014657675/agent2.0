...
<body  onload="set()">		  
		<form action="../../../toModule.do?prefix=/life&page=/agent/relation/add3.jsp?c_type=1" method="post" onsubmit="return check_form(this)">	 
		...
		<form action="../../../toModule.do?prefix=/life&page=/agent/relation/add2.jsp" method="post">
		<table width="100%" border="1" cellspacing="0">
			...
			<ul>
			<li>省公司员工开单，需要先添加直营事业部血缘关系，然后才可以录入投保单信息。</li>
			</ul>	 
	</body>			 
</html:html>
