...
<body>
<form action="../../../toModule.do?prefix=/life&page=/base/sxbd/query3.jsp"  method="post" onsubmit="return check_form(this)"> 
		...
		<table width="100%" border="1" cellspacing="0">
			...
			<td  align="left">
			<input name="c_tbd" value="" size="60" id="req" title="投保单号必须填写">
			</td>
			</tr>
			<tr>				
				<td align="right">
...
<form action="../../../toModule.do?prefix=/life&page=/base/sxbd/query2.jsp"  method="post" onsubmit="return check_form(this)"> 
