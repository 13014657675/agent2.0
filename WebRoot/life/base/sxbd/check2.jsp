...
<html:html lang="true">   
	...
	<body >
		<sql:query var="sxbd" dataSource="${db_mssql }" sql="select * from t_sxbd 
		...
		<table width="100%" border="0" cellspacing="0" align="center" >
				...
				<td width="10%"><nested:select property="c_bbrrel1" value="${fn:trim(sxbd.rows[0].c_bbrrel1) }">
				...
				<td width="10%"><nested:select property="c_bbrrel2" value="${fn:trim(sxbd.rows[0].c_bbrrel2) }">
								<html:option value="本人">本人</html:option>
								<html:option value="配偶">配偶</html:option>
								<html:option value="父母">父母</html:option>
								<html:option value="子女">子女</html:option>
				...
				<td width="10%"><nested:select property="c_bbrrel3" value="${fn:trim(sxbd.rows[0].c_bbrrel3) }">
								<html:option value="本人">本人</html:option>
								<html:option value="配偶">配偶</html:option>
								<html:option value="父母">父母</html:option>
								<html:option value="子女">子女</html:option>
				...
				<tr>
				<nested:hidden property="c_no" value="${sxbd.rows[0].c_no }"></nested:hidden>
				...
				<td colspan="2">投保单号：<nested:text property="c_tbd" value="${sxbd.rows[0].c_tbd }" size="60" styleId="req" title="投保单号必须填写" onchange="check()" ></nested:text> </td>
				<td colspan="3">投保日期：<nested:text property="c_tbrq" maxlength="8" value="${sxbd.rows[0].c_tbrq }" styleId="req" title="投保日期必须填写"></nested:text> </td>					
				</tr>
				<tr>
				...
				select c_outletsid from t_bankrelate where c_jobnumber = '${sxbd.rows[0].c_jobnumber }' and c_flag='0'
				)"></sql:query>
				...
				<td><nested:hidden property="c_jfqx" value="-1"></nested:hidden><nested:text property="c_bxje" value="${rowp.c_bxje }" size="15" onchange="reg_num(this)"></nested:text></td>
