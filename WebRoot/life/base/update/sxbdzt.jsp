...
<body>
<form action="../../../toModule.do?prefix=/life&page=/base/update/sxbdzt2.jsp"  method="post" onsubmit="return check_form(this)"> 
...
<ul>
<li><font color="red">可以恢复“撤单”、“犹豫期退保”、“正常退保”、“保单终止”为正常状态</font></li>
</ul>
</body>
</html:html>
