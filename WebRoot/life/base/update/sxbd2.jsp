...
<html:html lang="true">   
	...
	<script type="text/javascript">
		function check1()
		{
			...
			Company.get_length(c_companyid, back1);
			return false;
		}
		function back1(data)
		{ 
		...
		{
			var c_companyid=document.getElementsByName("sxbd.c_companyid")[0].value 
			Company.get_length(c_companyid, back2);
			return false;
		}
		function back2(data)
		{ 
	...
	<body >
		...
		<table width="100%" border="0" cellspacing="0" align="center" >
				...
				<td colspan="2">投保单号：<nested:text property="c_tbd" value="${sxbd.rows[0].c_tbd }" size="60" styleId="req" title="投保单号必须填写" onchange="check1()"></nested:text> </td>
				...
				<nested:text property="c_bd" value="${sxbd.rows[0].c_bd }" size="60" styleId="req" title="保单号必须填写" onchange="check2()"></nested:text> </td>
				</tr>
				<tr>
...
<script type="text/javascript">	 
	...
	{	
		...
		cell4.innerHTML="<td  ><input name=sxbd.c_jfqx value=\"\" onchange=\"reg_num(this)\" size=2></</td>";	
		var cell5 = row.insertCell(); 
		cell5.innerHTML="<td  ><input name=sxbd.c_bxje value=\"\" onchange=\"reg_num(this)\" size=15></</td>";	
		var cell6 = row.insertCell(); 
		cell6.innerHTML="<td  ><input name=sxbd.c_bxf value=\"\" onchange=\"reg_num(this)\" size=10> 　<input type=button onclick=deleteitem(this,'tb') value='删除本行' id=del ></</td>";	 
	}	
