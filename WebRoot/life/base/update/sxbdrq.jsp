...
<body>
<form action="../../../toModule.do?prefix=/life&page=/base/update/sxbdrq2.jsp"  method="post" onsubmit="return check_form(this)"> 
...
<ul>
<li> <font color="red">只能修改“正常状态”的保单数据的“投保日期”、“承保日期”、“回执日期”</font> </li> 
</ul>
</body>
</html:html>
