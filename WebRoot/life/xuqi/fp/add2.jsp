...
<body>  
		...
		<table width="100%" border="1" cellspacing="0">
			...
			<tr>
				...
				<td colspan="3">
					 <nested:text property="c_code" value="" styleId="req" title="发票号码必须填写" size="40"></nested:text>
				</td>
			</tr> 	
			<tr>
				<td width="50%" align="right" colspan="3">实缴日期</td>
				<td colspan="3">
					 <nested:text property="c_fprq" value="" styleId="req" title="实缴日期必须填写" maxlength="8"></nested:text>
				</td>
			</tr> 			
			<tr>
			<td width="10%">保单年度</td>
			...
			<sql:query var="q4" dataSource="${db_mssql }" sql="select * from t_sxtb 
			...
			<td>
			<sql:query var="q6" dataSource="${db_mssql }" sql="select convert(char(8),dateadd(year, ${param.c_bdnd-1}, c_date),112) c_date from t_sxbdzt 
			...
			<nested:text property="c_bxf" value="" onchange="reg_num(this)"></nested:text>
			</td> 
			</tr>
			</c:forEach>
			</nested:nest>
