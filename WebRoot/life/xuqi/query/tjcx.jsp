...
<form action="../../../toModule.do?prefix=/life&page=/xuqi/query/tjcx2.jsp"  method="post" onsubmit="return check_form(this)"> 
		...
		<table width="100%" border="1" cellspacing="0">
			...
			<td  align="left">
			 	 <select name="c_jobnm">
			 	 <option value="a">录入日期</option>
			 	 <option value="b">实缴日期</option> 
			 	 </select>
			</td>
			</tr>	 
			<tr>
