...
<head>
	...
	<body>		
		<sql:query var="q1" dataSource="${db_mssql }" sql="select * from t_exptype where c_no = ${param.c_no } "></sql:query>
		<html:form  action="/lifesolve" onsubmit="return check_form(this)">
		<html:hidden property="jobname" value="exptype"/>
		...
		<table width="100%" border="1" cellspacing="0">
			...
			<tr>
				...
				<td>
					<sql:query var="a1"	sql="select * from t_policy where c_ptnature=3001 order by c_system "	dataSource="${db_mssql}"></sql:query>
			...
			<tr>
				<td width="48%"><div align="right">佣金项目名称</div></td>
				<td width="52%" >
				<div align="left">
