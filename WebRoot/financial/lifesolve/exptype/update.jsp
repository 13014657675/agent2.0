...
<head>
	...
	<body>
		<table width="100%" border="1" cellspacing="0">
			...
			<td width="33%"><div align="center">佣金项目名称</div></td>
			<td width="33%"><div align="center">修改</div></td>
			</tr>
			<sql:query var="q2" dataSource="${db_mssql }" sql="select * from  t_exptype order by c_no"></sql:query>
			...
			<td width="50%" valign="middle" align="center"> 		
			 <a href="../../../toModule.do?prefix=/financial&page=/lifesolve/exptype/update2.jsp?c_no=${row.c_no }">修改</a>
			</td></tr>
			</c:forEach></table>
			</body> 
