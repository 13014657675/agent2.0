...
<head>
	...
	<script type="text/javascript">
		...
		function get(datas)
		{					 
			DWRUtil.removeAllOptions('c_orgid_sq');					
			DWRUtil.addOptions('c_orgid_sq', datas, 'value', 'label'); 			 
		} 		 
	</script>
</head>
<body onload="set()">
	<form action="../../../toModule.do?prefix=/financial&page=/lifesolve/query/expend2.jsp" method="post" onsubmit="return check_form(this)"> 
