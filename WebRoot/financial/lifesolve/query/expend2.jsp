...
<head>
	...
	<body>	
		...
		<c:if test="${q.rows[0].c_order==3 }">
			<form action="../../../toModule.do?prefix=/financial&page=/lifesolve/query/expend3.jsp?c_orgtypeid=${param.c_orgtypeid }" method="post">
			...
			<input name="c_year" value="2013" size="4" maxlength="4" id="req" title="年必须填写" onchange="reg_num(this)"> 
			</td></tr>	
			<tr>	
		...
		<c:if test="${q.rows[0].c_order==4 }">
			...
			{  
				...
				Organization.get_childdept_type(jigou3,3001, get3);
				return false;
			}
			function get3(datas)
			{	
