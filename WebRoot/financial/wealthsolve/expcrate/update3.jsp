...
<body >				
		<form action="../../../toModule.do?prefix=/financial&page=/wealthsolve/expcrate/update4.jsp?c_orgid=${param.c_orgid }" method="post">
		<table width="100%" border="1" cellspacing="0">
			...
			<script type="text/javascript">	
				...
				function set2()
				{
					...
					Product.get_expcrate_ksrq(c_orgid,c_companyid,c_productid,c_year,c_type,get2);
