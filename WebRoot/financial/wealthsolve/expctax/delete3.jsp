...
<body >				
		<form action="../../../toModule.do?prefix=/financial&page=/wealthsolve/expctax/delete4.jsp?c_orgid=${param.c_orgid }" method="post">
		<table width="100%" border="1" cellspacing="0">
			...
			<script type="text/javascript">	
				...
				function set2()
				{
					...
					Product.get_expctax_ksrq(c_orgid,c_companyid,c_productid,c_year,c_type,get2);
					return false;
				}	
				function get2(datas)
				{					
