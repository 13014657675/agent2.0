...
<head>
	...
	<body>	
		...
		<c:if test="${q.rows[0].c_order==3 }">
			<form action="../../../toModule.do?prefix=/financial&page=/wealthsolve/advance/add3.jsp?c_type=1&c_orgtypeid=${param.c_orgtypeid }" method="post">
		...
		<c:if test="${q.rows[0].c_order==4 }">
			...
			{  
				...
				Organization.get_childdept_typesystem(jigou3,3002,11, get3);
				return false;
			}
			function get3(datas)
			{	
