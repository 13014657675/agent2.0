...
<head>
	...
	<body>	
		...
		<c:if test="${q.rows[0].c_order==1 }">
			...
			<sql:query var="q1" dataSource="${db_mssql }" sql="select * from t_organization  where c_orgtypeid=${param.c_orgtypeid }  "></sql:query>
		...
		<c:if test="${q.rows[0].c_order==2 }">
			<form action="../../../toModule.do?prefix=/system&page=/organization/organization/switch3.jsp" method="post">
			...
			<tr>
				...
				<div align="left">
					...
					<sql:query var="q2" dataSource="${db_mssql }" sql="select * from t_organization where c_parent=-1 "></sql:query>
