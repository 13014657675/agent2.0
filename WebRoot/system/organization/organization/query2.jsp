...
<head>
	...
	<body>	
		...
		<c:if test="${q.rows[0].c_order==1 }">
			...
			<td width="20%" align="center">	<a href="../../../toModule.do?prefix=/system&page=/organization/organization/query4.jsp?c_no=${row.c_no }&c_orgtypeid=${param.c_orgtypeid }">查询</a>	</td>			 
			</tr></c:forEach></table>			 			
		</c:if>
		<c:if test="${q.rows[0].c_order==2 }">
			<form action="../../../toModule.do?prefix=/system&page=/organization/organization/query3.jsp" method="post">
