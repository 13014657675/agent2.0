		...
		<table width="100%" border="1" cellspacing="0" id="tb">
			...
			<tr> 
				<td  width="50%"  align="center">
					 ...
					 <nested:text property="c_pname" size="60" value="" styleId="req" title="保险责任名称必须填写"></nested:text>
				</td>
				<td  width="50%">
					 <nested:textarea property="c_pdesc" value="" cols="100" rows="5" styleId="req" title="保险责任描述必须填写"></nested:textarea>
				</td> 
			</tr>  			 
		  <tr> 
			<td align="right">
				<input type="button" value=" 添加保险责任 " onclick="add()">
