...
<body >	  
		<table width="100%" border="1" cellspacing="0">		
			...
			<tr> 
				...
				<td align="center">
				<a href="../../../toModule.do?prefix=/system&page=/product/ptrate/update3.jsp?c_companyid=${param.c_companyid }&c_productid=${param.c_productid }&c_type=${row.c_type }&c_base=${row.c_base }&c_bxqlx=${row.c_bxqlx }&c_bxq=${row.c_bxq }&c_jfqlx=${row.c_jfqlx }&c_jfq=${row.c_jfq }">修改</a>   
				</td>
			</tr>
			</c:forEach>						
		</table> 
