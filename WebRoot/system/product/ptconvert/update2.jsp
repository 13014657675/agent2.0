...
<body >	  
		<table width="100%" border="1" cellspacing="0">		
			...
			<tr> 
				...
				<td align="center">
				<a href="../../../toModule.do?prefix=/system&page=/product/ptconvert/update3.jsp?c_companyid=${param.c_companyid }&c_productid=${param.c_productid }&c_convertT=${row.c_convertT }">修改</a>   
				</td>
			</tr>
			</c:forEach>						
		</table> 
