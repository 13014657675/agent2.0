...
<body>
		...
		<table width="100%" border="1" cellspacing="0">
			...
			<tr>
				...
				<td width="20%"><div align="center">险种全称</div></td>
				<td width="10%"><div align="center">险种简称</div></td>
				<td width="10%"><div align="center">销售</div></td>
				<td width="10%"><div align="center">设置</div></td>
			</tr>		
			<c:forEach items="${q1.rows }" var="row">
		 	<tr>
				...
				<td ><div align="center">
					<c:choose>
					<c:when test="${row.c_flag eq '0'}">启售</c:when>
					<c:when test="${row.c_flag eq '1'}">停售</c:when>
					</c:choose>
				</div></td>
				<td ><div align="center">
				<a href="../../../toModule.do?prefix=/system&page=/product/product/sale3.jsp?c_no=${row.c_no }">设置</a>				
				</div></td>
			</tr>		
			</c:forEach> 
		</table>	 
