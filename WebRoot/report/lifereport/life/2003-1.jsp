...
<head>
	...
	<body onload="set();">		
		<form action="../../../toModule.do?prefix=/report&page=/lifereport/life/2003-2.jsp" method="post" onsubmit="return check_form(this)">
		<input name="c_time" value="<%=new Date().getTime()%>" type="hidden">
		<input name="c_code" value="2003" type="hidden">
