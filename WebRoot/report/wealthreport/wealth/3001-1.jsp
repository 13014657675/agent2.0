...
<head>
	...
	<body onload="set();">		
		<form action="../../../toModule.do?prefix=/report&page=/wealthreport/wealth/3001-2.jsp" method="post" onsubmit="return check_form(this)">
		<input name="c_time" value="<%=new Date().getTime()%>" type="hidden">
		<input name="c_code" value="3001" type="hidden">
		<table width="100%" border="1" cellspacing="0">
			...
			<tr>
			<td align="right" width="50%">产险事业部</td>
			<td> 
			<select name="c_system">
			<option value="11">产险</option> 
			</select>
			</td>				
			</tr>	
			<tr>
			<td align="right" width="50%">签单开始日期</td>
			<td> 
			<input name="c_ksrq" value="" id="req" title="签单开始日期必须填写" maxlength="8">
			</td>				
			</tr>	
			<tr>
			<td align="right" width="50%">签单结束日期</td>
			<td> 
			<input name="c_jsrq" value="" id="req" title="签单结束日期必须填写" maxlength="8">
			</td>				
			</tr>	
			<tr>
