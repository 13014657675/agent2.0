...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../../tool/styles/main.css">	
		...
		<table width="100%" border="1" cellspacing="0">
				...
				<tr>
				<td align="center" width="14%">上级机构</td>
				<td align="center" width="14%">机构名称</td>
				<td align="center" width="14%">工号</td>
				<td align="center" width="14%">姓名</td>
				<td align="center" width="14%">业务政策</td>
				<td align="center" width="14%">推荐人工号</td> 
				<td align="center" width="14%">推荐人姓名</td>   
				</tr>				
				<c:choose>
