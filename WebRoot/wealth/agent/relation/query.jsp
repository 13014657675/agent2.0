...
<body  onload="set()">		  
		<form action="../../../toModule.do?prefix=/wealth&page=/agent/relation/query3.jsp?c_type=1" method="post" onsubmit="return check_form(this)">	 
		...
		<form action="../../../toModule.do?prefix=/wealth&page=/agent/relation/query2.jsp" method="post">
