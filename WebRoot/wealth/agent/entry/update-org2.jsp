...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../../tool/styles/main.css">	
		...
		<table width="100%" border="1" cellspacing="0">
				...
				<sql:query var="q1" sql="select * from t_staff a,t_agentset b where a.c_jobnumber='${param.c_jobnumber }' 
					and a.c_orgid in (
						...
						select c_no from  t_organization where c_parent in (
							select c_no from  t_organization where c_deptid in (
								select c_no from t_dept  where c_ptnature=3002 and c_system=11 )))
					and a.c_jobnumber=b.c_jobnumber and b.c_flag='0'  " dataSource="${db_mssql }"></sql:query> 		
				...
				<td align="center">
				 		<A href="../../../toModule.do?prefix=/wealth&page=/agent/entry/update-org3.jsp?c_jobnumber=${row.c_jobnumber }">修改</A>
				</td>
				</tr>
				</c:forEach> 
