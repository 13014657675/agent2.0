...
<body  onload="set()">		  
		<form action="../../../toModule.do?prefix=/wealth&page=/agent/entry/update3.jsp?c_type=1" method="post" onsubmit="return check_form(this)">	 
		...
		<form action="../../../toModule.do?prefix=/wealth&page=/agent/entry/update2.jsp" method="post">
