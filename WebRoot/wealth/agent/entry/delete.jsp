...
<body  onload="set()">		  
		<form action="../../../toModule.do?prefix=/wealth&page=/agent/entry/delete3.jsp?c_type=1" method="post" onsubmit="return check_form(this)">	 
		...
		<form action="../../../toModule.do?prefix=/wealth&page=/agent/entry/delete2.jsp" method="post">
