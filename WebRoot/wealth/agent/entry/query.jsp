...
<body onload="set();" >		  
		<form action="../../../toModule.do?prefix=/wealth&page=/agent/entry/query3.jsp?c_type=1" method="post" onsubmit="return check_form(this)">	 
		...
		<form action="../../../toModule.do?prefix=/wealth&page=/agent/entry/query3.jsp?c_type=2" method="post" onsubmit="return check_form(this)">	 
		<table width="100%" border="0" cellspacing="0">
			<tr>
				<td height="33" colspan="3" background="../../../tool/images/113.gif">
					<div align="left">
		...
		<form action="../../../toModule.do?prefix=/wealth&page=/agent/entry/query2.jsp" method="post">
