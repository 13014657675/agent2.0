...
<body onload="init();">
<form action="../../../toModule.do?prefix=/wealth&page=/base/query/tjcx2.jsp"  method="post" onsubmit="return check_form(this)"> 		 
...
<form action="../../../toModule.do?prefix=/wealth&page=/base/query/tjcx3.jsp?c_type=2"  method="post" onsubmit="return check_form(this)"> 		 
		<table width="100%" border="1" cellspacing="0">
			<tr>
				<td height="33" colspan="2" background="../../../tool/images/113.gif">
					<div align="left">
			...
			<td  align="left">
			 	 <select name="c_jobnm">
			 	 <option value="a">签单日期</option>
			 	 <option value="b">起保日期</option>
			 	 </select>
			</td>
			</tr>	 
			<tr>
...
<form action="../../../toModule.do?prefix=/wealth&page=/base/query/tjcx3.jsp?c_type=3"  method="post" onsubmit="return check_form(this)"> 		 
		<table width="100%" border="1" cellspacing="0">
			<tr>
				<td height="33" colspan="2" background="../../../tool/images/113.gif">
					<div align="left">
