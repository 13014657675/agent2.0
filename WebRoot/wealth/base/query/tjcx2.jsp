...
<head>
	...
	<body>	
		...
		<c:if test="${q.rows[0].c_order==3 }">
			<form action="../../../toModule.do?prefix=/wealth&page=/base/query/tjcx3.jsp?c_type=1&c_orgtypeid=${param.c_orgtypeid }" method="post" onsubmit="return check_form(this)">
		...
		<c:if test="${q.rows[0].c_order==4 }">
			...
			{  
				...
				Organization.get_childdept_type(jigou3,3002, get3);
				return false;
			}
			function get3(datas)
			{	
