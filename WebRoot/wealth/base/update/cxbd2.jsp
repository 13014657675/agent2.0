...
<html:html lang="true">   
	...
	<body onload="setname()">
		<sql:query var="cxbd"  sql="select * from t_cxbd where c_companyid=${param.c_companyid } and c_bd='${param.c_bd }' and c_jobnm='0' and c_flag='0' " dataSource="${db_mssql}"></sql:query>
		...
		<table width="100%" border="0" cellspacing="0" align="center" >
				...
				<td align="left" width="16%">
				<nested:text property="c_platenumber" value="${cxbd.rows[0].c_platenumber }" size="30"></nested:text>
				</td>
				<td align="right" width="16%">
				车驾号：
				</td>
				<td align="left" width="16%">
				<nested:text property="c_hisnumber" value="${cxbd.rows[0].c_hisnumber }" styleId="req" title="车驾号必须填写！" size="30"></nested:text>
				</td>
				<td colspan="2"></td>
				</tr>
				<tr>
				...
				<td align="right" width="16%">证件类型：</td>
			 	...
			 	<td align="left" width="16%">
			 			<nested:text property="c_dzserial" value="${cxbd.rows[0].c_dzserial }"  size="40"></nested:text>
			 	</td>
			 	<td colspan="2">			 			
			 	</td>
			 	</tr> 
