...
<html:html lang="true">   
	...
	<body onload="setname()">
		<sql:query var="cxbd"  sql="select * from t_cxbd where c_companyid=${param.c_companyid } and c_bd='${param.c_bd }' and c_jobnm='add' and c_flag='0' " dataSource="${db_mssql}"></sql:query>
