...
<html:html lang="true">   
	...
	<body >
		...
		<table width="100%" border="0" cellspacing="0" align="center" >
				...
				<td align="left" width="16%">
				<nested:text property="c_bd" styleId="req" title="保单号必须填写！" size="40" onchange="check()" value=""></nested:text>
				</td>
				<td align="right" width="16%">保险费：</td>
				<td align="left" width="16%">
				<nested:text property="c_bxf" value="" onchange="reg_num(this)" styleId="req" title="保险费必须填写！"></nested:text>
				</td>
				<td align="right" width="16%">车船税：</td>
				<td align="left" width="16%">
				<nested:text property="c_ccs" value="" onchange="reg_num(this)" styleId="req" title="车船税必须填写！"></nested:text>
				</td>
				</tr> 	
				<tr>
				...
				<td align="left" width="16%">
				<nested:text property="c_platenumber" value="" styleId="req" title="车牌号码必须填写！"  size="30"></nested:text>
				</td>
				<td align="right" width="16%">
				车驾号：
				</td>
				<td align="left" width="16%">
				<nested:text property="c_hisnumber" value="" size="30"></nested:text>
				</td>
				<td colspan="2"></td>
				</tr>
				<tr>
				...
				<td align="left" width="16%">
				<nested:text property="c_customer" value="" styleId="req" title="被保险人姓名必须填写！"></nested:text>				
				</td>
				<td align="right" width="16%">证件类型：</td>
			 	...
			 	<td align="left" width="16%"><nested:text property="c_cardnum" value="" size="40" styleId="req" title="证件号码必须填写！"></nested:text></td>
				</tr>			 
			 	<tr>
			 	<td align="right" width="16%">代理人工号：</td>
			 	<td align="left" width="16%"><nested:text property="c_jobnumber" value=""  styleId="req" title="代理人工号必须填写！" onchange="setname()"></nested:text></td>
			 	...
			 	<td align="left" width="16%">
			 			...
			 			<nested:select property="c_usageid">
			 	...
			 	<td align="left" width="16%">
			 			<nested:text property="c_fpserial" value=""  size="40" ></nested:text>
			 	</td>
			 	<td align="right" width="16%">单证流水号：</td>
			 	<td align="left" width="16%">
			 			<nested:text property="c_dzserial" value=""  size="40" styleId="req" title="单证流水号必须填写！" ></nested:text>
			 	</td>
			 	<td colspan="2">			 			
			 	</td>
			 	</tr> 
			 	...
			 	<td align="left" width="16%"><nested:text property="c_lrrq" value=""  styleId="req" title="签单日期必须填写！" maxlength="8"></nested:text></td>
			 	<td align="right" width="16%">起保日期：</td>
			 	<td align="left" width="16%"><nested:text property="c_cbrq" value=""  styleId="req" title="起保日期必须填写！" maxlength="8"></nested:text></td>
			 	<td colspan="2"></td>
			 	</tr> 			 	
				</nested:nest>
				<tr> 
