...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../../tool/styles/main.css"> 
		...
		<table width="100%" border="1" cellspacing="0">
				...
				<sql:query var="q1" dataSource="${db_mssql }" sql="select distinct c_jobnumber  from t_postset where c_orgid= ${param.c_orgid }"></sql:query>  
				...
				<nested:text property="c_code" value="" size="30"></nested:text>
				</td>				
				</tr>
				</c:forEach>				 	 
				<tr>
