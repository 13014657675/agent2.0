...
<head>
	...
	<script type="text/javascript">
		...
		<body onload="set()">
		<form action="../../../toModule.do?prefix=/person&page=/staff/menu/set3.jsp?c_type=1" method="post"> 
		...
		<form action="../../../toModule.do?prefix=/person&page=/staff/menu/set2.jsp" method="post"> 
		<table width="100%" border="1" cellspacing="0">
				<tr>
					<td height="33" colspan="2" background="../../../tool/images/113.gif">
						<div align="left">
