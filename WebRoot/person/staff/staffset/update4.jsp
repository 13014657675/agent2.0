...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../../tool/styles/main.css">	
		...
		<sql:query var="q1" dataSource="${db_mssql }" sql="select * from t_staff where c_jobnumber='${param.c_jobnumber }'"></sql:query>
		<body>
		<html:form  action="/staff" onsubmit="return check_form(this)">
		<html:hidden property="jobname" value="staffset"/>
		...
		<nested:hidden property="c_no" value="${q1.rows[0].c_no }"></nested:hidden> 
		 <table width="100%" border="1" cellspacing="0">
			...
			<tr>
				...
				<td width="10%">性别</td>
				<td width="23%">									
					<c:set target="${staffForm.staff }" property="c_sex" value="${q1.rows[0].c_sex }"></c:set>
					<nested:radio property="c_sex" value="1">男</nested:radio>
					<nested:radio property="c_sex" value="0">女</nested:radio>
				</td>
				<td width="10%">出生年月日</td>
				<td width="23%"><nested:text property="c_birthday" onchange="reg_csny(this)" alt="出生年月日格式不正确" value="${q1.rows[0].c_birthday }"  /></td>							
			</tr>
			<tr>			
				<td width="5%">年龄</td>
			...
			<tr>			
				...
				<td>婚姻状况</td>
				<td> 
					<c:set target="${staffForm.staff }" property="c_marriage" value="${q1.rows[0].c_marriage }"></c:set>
						...
						<table width="100%" border="0"class="nobordert">
							...
							<tr>
								<td align="center"  colspan="2">
									<nested:text property="c_sqi1" value="${q1.rows[0].c_sqi1 }" maxlength="8" size="8" />	
									至<nested:text property="c_szhi1" value="${q1.rows[0].c_szhi1 }" maxlength="8" size="8" />									 
								</td> 
								<td colspan="2">
									<div align="center" >
							...
							<tr>
								<td align="center"  colspan="2">
									<nested:text property="c_sqi2" value="${q1.rows[0].c_sqi2 }" maxlength="8" size="8" />
									至<nested:text property="c_szhi2" value="${q1.rows[0].c_szhi2 }" maxlength="8" size="8" />								 
								</td> 
								<td colspan="2">
									<div align="center"  >
							...
							<tr>
								<td align="center"  colspan="2">
									<nested:text property="c_sqi3" value="${q1.rows[0].c_sqi3 }" maxlength="8" size="8" />		
									至<nested:text property="c_szhi3" value="${q1.rows[0].c_szhi3 }" maxlength="8" size="8" />							 
								</td> 
								<td colspan="2">
									<div align="center"  >
				...
				<td colspan="8">
					<div align="center">
						<table width="100%" border="0" class="nobordert">
							...
							<tr>
								<td align="center"  colspan="2">
									<nested:text property="c_wqi1" value="${q1.rows[0].c_wqi1 }" maxlength="8" size="8" />	
									至<nested:text property="c_wzhi1" value="${q1.rows[0].c_wzhi1 }" maxlength="8" size="8" />								 
								</td> 
								<td colspan="2">
									<div align="center"  >
							...
							<tr>
								<td align="center"  colspan="2">
									<nested:text property="c_wqi2" value="${q1.rows[0].c_wqi2 }" maxlength="8" size="8" />	
									至<nested:text property="c_wzhi2" value="${q1.rows[0].c_wzhi2 }" maxlength="8" size="8" />								 
								</td> 
								<td colspan="2">
									<div align="center" >
							...
							<tr>
								<td align="center"  colspan="2">
									<nested:text property="c_wqi3" value="${q1.rows[0].c_wqi3 }" maxlength="8" size="8" />	
									至<nested:text property="c_wzhi3" value="${q1.rows[0].c_wzhi3 }" maxlength="8" size="8" />								 
								</td> 
								<td colspan="2">
									<div align="center"  >
							...
							<tr>
								<td align="center"  colspan="2">
									<nested:text property="c_wqi4" value="${q1.rows[0].c_wqi4 }" maxlength="8" size="8" />	
									至<nested:text property="c_wzhi4" value="${q1.rows[0].c_wzhi4 }" maxlength="8" size="8" />								 
								</td> 
								<td colspan="2">
									<div align="center"  >
							...
							<tr>
								<td align="center"  colspan="2">
									<nested:text property="c_wqi5" value="${q1.rows[0].c_wqi5 }" maxlength="8" size="8" />	
									至<nested:text property="c_wzhi5" value="${q1.rows[0].c_wzhi5 }" maxlength="8" size="8" />								 
								</td> 
								<td colspan="2">
									<div align="center" >
							...
							<tr>
								<td align="center"  colspan="2">
									<nested:text property="c_wqi6" value="${q1.rows[0].c_wqi6 }" maxlength="8" size="8" />	
									至<nested:text property="c_wzhi6" value="${q1.rows[0].c_wzhi6 }" maxlength="8" size="8" />								 
								</td> 
								<td colspan="2">
									<div align="center"  >
