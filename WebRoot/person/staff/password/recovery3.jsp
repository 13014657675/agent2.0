...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../../tool/styles/main.css"> 
		...
		<table width="100%" border="1" cellspacing="0">
				...
				<td align="center" width="20%">设置</td>
				</tr>					
				<c:choose>
				<c:when test="${param.c_type eq 1 }">
				<sql:query var="q1" dataSource="${db_mssql }" sql="select  c_jobnumber,c_orgid from t_staff 
				...
				<td align="center" width="20%">${row.c_jobnumber }</td> 
				<td align="center" width="20%">
					<sql:query var="q4" dataSource="${db_mssql }" sql="select * from t_staff where c_jobnumber='${row.c_jobnumber }' "></sql:query> 
					${q4.rows[0].c_name }
				</td> 
				<td align="center" width="20%">
				 <A href="../../../toModule.do?prefix=/person&page=/staff/password/recovery4.jsp?c_jobnumber=${row.c_jobnumber }">设置</A>
				</td>		
				</tr>	
				</c:forEach>			 
				</table>		 
