...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../../tool/styles/main.css">
		...
		<table width="100%" border="1" cellspacing="0">
				...
				<td align="center" width="25%">查询</td>
				</tr>
				<c:forEach items="${q1.rows }" var="row">
					...
					<td align="center" width="25%">
					<a href="../../../toModule.do?prefix=/person&page=/pay/coefficientset/query3.jsp?c_orgid=${param.c_orgid }&c_pcoefficient=${row.c_pcoefficient }&c_year=${row3.c_year }&c_number=${row3.c_number }&c_period=${q2.rows[0].c_period }">查询</a>					
					</td>
					</tr>  	 
					</c:forEach> 	
				</c:forEach> 	 
